...
function App() {
  const [activePage, setActivePage] = useState<'calculator' | 'blackjack'>('calculator')
  ...
  return (
    <Container>
      <Header>
        ...
        <Description>
          Your ultimate card game companion. Calculate probabilities and play classic blackjack.
        </Description>
      </Header>
